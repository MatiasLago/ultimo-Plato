...
export default function ReservationModal({ reservation, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 sm:p-6 overflow-y-auto">
      {/* Container */}
      <div className="relative w-full max-w-md bg-card-bg rounded-3xl overflow-hidden shadow-2xl border border-border-custom flex flex-col my-auto animate-float">
