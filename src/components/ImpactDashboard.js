    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 flex-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        ...
        <div className="bg-card-bg border border-border-custom rounded-2xl p-5 shadow-xs relative overflow-hidden">
          <div className="absolute top-0 right-0 h-16 w-16 bg-primary/5 rounded-bl-full flex items-center justify-end pr-3.5 pt-3 text-primary">
        ...
        {/* Indicator 3 */}
        <div className="bg-card-bg border border-border-custom rounded-2xl p-5 shadow-xs relative overflow-hidden">
          <div className="absolute top-0 right-0 h-16 w-16 bg-orange-500/5 rounded-bl-full flex items-center justify-end pr-3.5 pt-3 text-secondary">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-8">
        ...
        <div className="lg:col-span-5 bg-neutral-900 text-white rounded-3xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="border-t border-neutral-800 pt-6 mt-8 grid grid-cols-2 gap-4 relative z-10">
            <div>
              <span className="text-xs text-neutral-500 block uppercase font-bold">CO₂ Equivalente Evitado</span>
              <span className="text-2xl font-black text-primary block mt-1">{co2SavedKg} kg</span>
              <span className="text-[10px] text-neutral-500 block mt-0.5">Equivale a plantar {Math.ceil(co2SavedKg / 20)} árboles</span>
            </div>
            <div>
              <span className="text-xs text-neutral-500 block uppercase font-bold">Agua Dulce Salvada</span>
              <span className="text-2xl font-black text-secondary block mt-1">{waterSavedLiters.toLocaleString("es-AR")} L</span>
              <span className="text-[10px] text-neutral-500 block mt-0.5">Equivale a {Math.ceil(waterSavedLiters / 250)} duchas de 10 min</span>
            </div>
          </div>
        </div>
